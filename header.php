...
<html lang="en">
  ...
  <input type="text" class="alert alert-success" name="username">     
  <label for="password"> Password </label>
  <input type="password" class="alert alert-success" name="password">
  <button type="submit" class="btn btn-primary" > Sign in </button></P>
  </form>

    <nav class="navbar navbar-expand-lg navbar-light bg-light">
  <a class="navbar-brand" href="/crud/">FAH</a>
